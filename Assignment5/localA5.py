...
def createHTMLPage(infoList,numb):
    ...
    while idx < len(infoList):
        htmlBody = (htmlBody +"    <a href = " + str(infoList[idx + 1])[29:]  +
...
def createIdxHtml():
    ...
    body = ("<!DOCTYPE HTML>\n<html>\n  <head>\n    <title>Index" +
           ...
           "r>\n    CSC 344 - Spring<br>\n    Assignment 5<br><" +
           "br>\n\n    <a href = ../s" +
           "ummary_a1.html>Assignment 1</a><br>\n    <a href = " +
           "../summary_a2.html>Assignm" +
           "ent 2</a><br>\n    <a href = " +
           "../summary_a3.html>Assignment 3</a><br>\n    <a" +
           " href = ../summary_a4.htm" +
           "l>Assignment 4</a><br>\n    <a href = " +
           "../summary_a5.html>Assignment 5</a><br" +
           "><br>\n\n  </body>\n</html>")
